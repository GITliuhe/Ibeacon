...
Page({
    ...
    upload: function() {
      ...
      wx.request({
        url: 'http://192.168.199.173:8081/add//rssi/fingerprint',
        method: "POST",
    ...
    onBluetoothDeviceFound: function() {
      var that = this;
      var beacon = { beaconOne: "", rssiOne: 0, beaconTwo: "", rssiTwo: 0,
                     beaconThree: "", rssiThree: 0, BeaconName: ""};
      wx.onBluetoothDeviceFound((res) => {  
        res.devices.forEach(function(device) {
          ...
          if(device.name == 'MBeacon') {
            ...
            console.log("采集次数设置为："+collectnum)
            if (beacon.rssiOne != 0 && beacon.rssiTwo !=0 && beacon.rssiThree != 0) {
              ...
              beacon = { beaconOne: "", rssiOne: 0, beaconTwo: "", rssiTwo: 0,
                         beaconThree: "", rssiThree: 0, BeaconName: ""};
              that.setData(data)
